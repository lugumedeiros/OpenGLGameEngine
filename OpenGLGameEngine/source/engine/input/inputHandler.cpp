...
void InputHandler::moveForward() {
	...
	cam->translateLocalSpace(glm::vec3(0.0f, 0.0f, speed));
}
...
void InputHandler::moveLeft() {
	Camera* cam = engine.getCamera();
	cam->translateLocalSpace(glm::vec3(-speed, 0.0f, 0.0f));
}
...
void InputHandler::moveUp() {
	Camera* cam = engine.getCamera();
	cam->translateLocalSpace(glm::vec3(0.0f, speed, 0.0f));
}
...
//void InputHandler::moveForward() {
//	Camera* cam = engine.getCamera();
//	cam->translateWorldSpace(glm::vec3(0.0f, 0.0f, -speed));
//}
//
//void InputHandler::moveBackward() {
//	Camera* cam = engine.getCamera();
...
//void InputHandler::moveLeft() {
//	Camera* cam = engine.getCamera();
//	cam->translateWorldSpace(glm::vec3(-speed, 0.0f, 0.0f));
//}
//
//void InputHandler::moveRight() {
//	Camera* cam = engine.getCamera();
...
//void InputHandler::moveUp() {
//	Camera* cam = engine.getCamera();
//	cam->translateWorldSpace(glm::vec3(0.0f, speed, 0.0f));
//}
//
//void InputHandler::moveDown() {
//	Camera* cam = engine.getCamera();
